...
56 cities data: Processed dataset used for the core analysis.
6 external cities data: Dataset used for the projection and visualisation of external cities in the Dashboard.
# Analysis Workflow
...
# Data
The repository contains processed data required for the analyses. The original source data are not redistributed in this repository. Information on data sources, definitions and processing procedures is provided in the dissertation.
